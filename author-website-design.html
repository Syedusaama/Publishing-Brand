			...
			<div class="row">
				<div class="col-sm-8">
					<div class="heading__web">
						<h2>Read the Reviews of Our Happy Clients</h2>
					...
					<div class="revieew__box review_slider">
						<div class="review__sec__item">
							...
							<div class="review__content">
								<p>Atlantic Book Publishers transformed my author website into a captivating space that truly reflects my brand. The personalized touch in their designs is unparalleled!</p>
							</div>

							<div class="review_auth">
								<div class="review__img">
									<img srcset="assets/images/review-img-61.png" class="img-responsive" alt="review">
								</div>
								<div class="review__auth">
									<span class="auth__name">Sarah M </span>
						...
						<div class="review__sec__item">
							...
							<div class="review__content">
								<p>I was impressed by the professionalism and creativity of Atlantic Book Publishers. My website now stands out, thanks to their excellent design services!</p>
							</div>

							<div class="review_auth">
								<div class="review__img">
									<img srcset="assets/images/review-img-62.png" class="img-responsive" alt="review">
								</div>
								<div class="review__auth">
									<span class="auth__name">John D </span>
						...
						<div class="review__sec__item">
							...
							<div class="review__content">
								<p>The team at Atlantic Book Publishers exceeded my expectations. They not only created a stunning website but also guided me through the entire process with patience and expertise.</p>
							</div>
							...
							<div class="review_auth">
								...
								<div class="review__auth">
									<span class="auth__name">Emily R </span>
						...
						<div id="accordion">
			                <div class="card mb-3">
			                  <div class="card-header" id="headingOne">
			                    <span class="mb-0">
			                      <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Can I choose specific features for my author's website?
			                  ...
			                  <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion" style="">
			                    <div class="card-body">
			                      Absolutely! Our packages are customizable, allowing you to select the features that best align with your unique preferences and requirements.
			                    </div>
			                  </div>
			                </div>
			                <div class="card mb-3">
			                  <div class="card-header" id="headingTwo">
			                    <span class="mb-0">
			                      <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">What factors may influence the timeline of the website design process?
			                      <i class="fa fa-angle-right float-right" aria-hidden="true"></i>
			                      </button>
			                    </span>
			                  </div>
			                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
			                    <div class="card-body">
			                      The complexity of your specific requirements influences the timeline for website design. While we prioritize timely delivery, the intricacy of design elements and special features may extend the project timeline. Rest assured, we are dedicated to delivering you with a stellar website in a reasonable timeframe.
			                    </div>
			                  </div>
			                </div>
			                <div class="card mb-3">
			                  <div class="card-header" id="headingTwo">
			                    <span class="mb-0">
			                      <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
			                    	Is SEO included in the website design packages?
			                      <i class="fa fa-angle-right float-right" aria-hidden="true"></i>
			                      </button>
			                    </span>
			                  </div>
			                  <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
			                    <div class="card-body">
			                        Yes, all our packages include SEO optimization to enhance your online visibility.
			                    </div>
			                  </div>
			                </div>
			                <div class="card mb-3">
			                  <div class="card-header" id="headingTwo">
			                    <span class="mb-0">
			                      <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">Can I update my website content after it's launched?
			                      <i class="fa fa-angle-right float-right" aria-hidden="true"></i>
			                      </button>
			                    </span>
			                  </div>
			                  <div id="collapse4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
			                    <div class="card-body">
			                       Certainly! We provide user-friendly interfaces and guidance for easy content updates.
			                    </div>
			                  </div>
			                </div>
			                ...
			                <div class="card mb-3">
			                  <div class="card-header" id="headingTwo">
			                    <span class="mb-0">
			                      <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">Do you offer ongoing assistance after the website is launched?
			                      <i class="fa fa-angle-right float-right" aria-hidden="true"></i>
			                      </button>
			                    </span>
			                  </div>
			                  <div id="collapse5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
			                    <div class="card-body">
			                        Yes, our 24/7 customer support ensures you have assistance whenever you need it.
			                    </div>
			                  </div>
			                </div>
			                ...
			                <div class="card mb-3">
			                  <div class="card-header" id="headingTwo">
			                    <span class="mb-0">
			                      <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6">Are there additional charges for a dedicated designer?
			                      <i class="fa fa-angle-right float-right" aria-hidden="true"></i>
			                      </button>
			                    </span>
			                  </div>
			                  <div id="collapse6" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
			                    <div class="card-body">
			                      No, our packages include a dedicated designer at no extra cost, ensuring a personalized touch to your website.
			                    </div>
			                  </div>
			                </div>
			            </div>
