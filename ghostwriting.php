        ...
        <div class="row">
            <div class="col-sm-10">
                <div class="heading__web">
                    <h2>Our Top-Tier Priority is Our Customers’ Satisfaction</h2>
                ...
                <div class="revieew__box review_slider">
                    <div class="review__sec__item">
                        ...
                        <div class="review__content">
                            <p>I stumbled upon Atlantic Book Publishers after a disappointing experience elsewhere. Their ghostwriting team not only revived my manuscript but also brought my vision to life. The personal touch and dedication surpassed my expectations. Highly recommend!</p>
                        </div>
                        ...
                        <div class="review_auth">
                            ...
                            <div class="review__auth">
                                <span class="auth__name">Henry </span>
                    ...
                    <div class="review__sec__item">
                        ...
                        <div class="review__content">
                            <p>Working with Atlantic Book Publishers was a game-changer for my memoir. They dug deep into my experiences, capturing emotions and moments that made my story uniquely mine. The collaborative process felt more like sharing stories with friends.</p>
                        </div>
                        ...
                        <div class="review_auth">
                            ...
                            <div class="review__auth">
                                <span class="auth__name">Amelia </span>
                                <span class="auth__des">Author</span>
                            </div>
                        </div>
                    ...
                    <div class="review__sec__item">
                        ...
                        <div class="review__content">
                            <p>Atlantic Book Publishers made my dream of writing a book come true. At 74, navigating the process seemed daunting, but their patience and guidance made it a breeze. Now, I hold my book in my hands, a testament to their expertise and genuine care. Forever grateful!</p>
                        </div>
                        ...
                        <div class="review_auth">
                            ...
                            <div class="review__auth">
                                <span class="auth__name">James </span>
                                <span class="auth__des">Author</span>
                            </div>
                        </div>
                    ...
                    <div id="accordion">
                        <div class="card mb-3">
                          <div class="card-header" id="headingTwo">
                            <span class="mb-0">
                              <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">How do you capture my unique voice and style? 
                          ...
                          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                              Through in-depth discussions and collaboration, we understand your voice, ensuring the final work reflects your tone and personality.    
                            </div>
                          </div>
                        </div>
                        <div class="card mb-3">
                          ...
                          <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                Certainly. We encourage collaboration, with multiple feedback opportunities to ensure your satisfaction at every stage.  
                            </div>
                          </div>
                        </div>
                        <div class="card mb-3">
                          <div class="card-header" id="headingTwo">
                            <span class="mb-0">
                              <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">What genres do you specialize in for ghostwriting? 
                              <i class="fa fa-angle-right float-right" aria-hidden="true"></i>
                              </button>
                            </span>
                          </div>
                          <div id="collapse4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                Our skilled ghostwriters have expertise in a wide range of genres, accommodating fiction, non-fiction, memoirs, and more.
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card mb-3">
                          <div class="card-header" id="headingTwo">
                            <span class="mb-0">
                              <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">How long does the ghostwriting process take? 
                              <i class="fa fa-angle-right float-right" aria-hidden="true"></i>
                              </button>
                            </span>
                          </div>
                          <div id="collapse5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                Timelines vary based on project scope, but we work efficiently to meet deadlines, providing a realistic timeframe during the proposal phase.
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card mb-3">
                          <div class="card-header" id="headingTwo">
                            <span class="mb-0">
                              <button class="btn btn-link text-left w-100 collapsed" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">Will I own the rights to the finished work?  
                              <i class="fa fa-angle-right float-right" aria-hidden="true"></i>
                              </button>
                            </span>
                          </div>
                          <div id="collapse7" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                Yes, you retain full rights to the finished work. We're only here to bring your vision to life, not to steal your thunder. Once the book is complete, you maintain full ownership.
                            </div>
                          </div>
                        </div>
