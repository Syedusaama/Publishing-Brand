...
<section class="review__sec__main padding__90">
	...
	<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
		...
		<div class="row align-items-center">
				<div class="col-md-6 ">
					<img class="d-block review-img" src="assets/images/reviews/book-editing/01.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						...
						<div class="review_auth">
							...
							<div class="review__auth">
								<span class="auth__name">Sawyer Blackwood</span>
		  ...
		  <div class="carousel-item">
			<div class="row align-items-center">
				<div class="col-md-6">
					<img class="d-block review-img" src="assets/images/reviews/book-editing/02.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						<div class="rating__review">
						...
						<div class="review_auth">
							...
							<div class="review__auth">
								<span class="auth__name">Noah Riley</span>
								<span class="auth__des">Author</span>
							</div>
						</div>
					</div>
		  ...
		  <div class="carousel-item">
			<div class="row align-items-center">
				<div class="col-md-6">
					<img class="d-block review-img" src="assets/images/reviews/book-editing/03.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						<div class="rating__review">
						...
						<div class="review_auth">
							...
							<div class="review__auth">
								<span class="auth__name">Mason Blake</span>
								<span class="auth__des">Author</span>
							</div>
						</div>
					</div>
