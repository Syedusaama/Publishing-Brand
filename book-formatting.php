...
<section class="review__sec__main padding__90">
	...
	<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
		...
		<div class="row align-items-center">
				<div class="col-md-6 ">
					<img class="d-block review-img" src="assets/images/reviews/book-formatting/01.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						...
						<div class="review_auth">
							...
							<div class="review__auth">
								<span class="auth__name">Evelyn Hawke</span>
		  ...
		  <div class="carousel-item">
			<div class="row align-items-center">
				<div class="col-md-6">
					<img class="d-block review-img" src="assets/images/reviews/book-formatting/02.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						<div class="rating__review">
						...
						<div class="review_auth">
							<div class="review__img">
								<img srcset="assets/images/review-img-72.png" class="img-responsive" alt="review">
							</div>
							<div class="review__auth">
								<span class="auth__name">Maxwell Arden</span>
								<span class="auth__des">Author</span>
							</div>
						</div>
					</div>
		  ...
		  <div class="carousel-item">
			<div class="row align-items-center">
				<div class="col-md-6">
					<img class="d-block review-img" src="assets/images/reviews/book-formatting/03.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						<div class="rating__review">
						...
						<div class="review_auth">
							<div class="review__img">
								<img srcset="assets/images/review-img-70.png" class="img-responsive" alt="review">
							</div>
							<div class="review__auth">
								<span class="auth__name">Jasper Kline</span>
								<span class="auth__des">Author</span>
							</div>
						</div>
					</div>
