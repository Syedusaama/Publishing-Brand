...
<section class="review__sec__main padding__90">
	...
	<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
		...
		<div class="row align-items-center">
				<div class="col-md-6 ">
					<img class="d-block review-img" src="assets/images/reviews/author-website-design/01.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						...
						<div class="review_auth">
							<div class="review__img">
								<img srcset="assets/images/review-img-69.png" class="img-responsive" alt="review">
							</div>
							<div class="review__auth">
								<span class="auth__name">Elias Thorn</span>
		  ...
		  <div class="carousel-item">
			<div class="row align-items-center">
				<div class="col-md-6">
					<img class="d-block review-img" src="assets/images/reviews/author-website-design/02.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						<div class="rating__review">
						...
						<div class="review_auth">
							...
							<div class="review__auth">
								<span class="auth__name">Sienna Drake</span>
								<span class="auth__des">Author</span>
							</div>
						</div>
					</div>
		  ...
		  <div class="carousel-item">
			<div class="row align-items-center">
				<div class="col-md-6">
					<img class="d-block review-img" src="assets/images/reviews/author-website-design/03.jpg" alt="First slide">
				</div>
				<div class="col-md-6">
					<div class="review__sec__item">
						<div class="rating__review">
						...
						<div class="review_auth">
							<div class="review__img">
								<img srcset="assets/images/review-img-57.png" class="img-responsive" alt="review">
							</div>
							<div class="review__auth">
								<span class="auth__name">Grayson Ashford</span>
								<span class="auth__des">Author</span>
							</div>
						</div>
					</div>
